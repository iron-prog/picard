...
class Ui_RenamingOptionsPage(object):
    def setupUi(self, RenamingOptionsPage):
        ...
        self.move_skip_existing_files = QtWidgets.QCheckBox(parent=self.move_files)
        self.move_skip_existing_files.setObjectName("move_skip_existing_files")
        self.verticalLayout_4.addWidget(self.move_skip_existing_files)
        ...
        RenamingOptionsPage.setTabOrder(self.move_overwrite_existing_files, self.move_skip_existing_files)
        RenamingOptionsPage.setTabOrder(self.move_skip_existing_files, self.rename_files)
    ...
    def retranslateUi(self, RenamingOptionsPage):
        ...
        self.move_skip_existing_files.setText(_("Skip moving files if destination already exists"))
